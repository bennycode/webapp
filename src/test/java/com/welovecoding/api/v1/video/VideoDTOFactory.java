...
public class VideoDTOFactory {
  ...
  public static VideoDTO constructVideoDTO(Integer id, int dept) {
    ...
    if (dept > -1) {
      ...
      return new VideoDTO(longId, "videoName", "description", "code", "prevUrl", "downloadUrl", "http://www.welovecoding.com/tutorials/categorySlug/playlistSlug?video=1", PlaylistDTOFactory.constructPlaylistDTO(1, 10, 1));
    }
    return null;
  }
