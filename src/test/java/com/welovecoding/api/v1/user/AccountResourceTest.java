...
public class AccountResourceTest {
	...
	public void testNonAuthenticatedUser() throws Exception {
		...
		restUserMockMvc.perform(get("/api/v1/account/authenticate").accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk())
	...
	public void testRegisterValid() throws Exception {
		...
		restMvc.perform(
			post("/api/v1/account/register").contentType(TestUtil.APPLICATION_JSON_UTF8).content(TestUtil.convertObjectToJsonBytes(u)))
	...
	public void testRegisterDuplicateLogin() throws Exception {
		...
		// Duplicate login
		restMvc.perform(
			post("/api/v1/account/register").contentType(TestUtil.APPLICATION_JSON_UTF8).content(TestUtil.convertObjectToJsonBytes(dup)))
