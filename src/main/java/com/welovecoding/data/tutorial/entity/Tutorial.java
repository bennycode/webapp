...
public class Tutorial extends SlugBaseEntity<Long> {
    ...
    Tutorial(Long id, Date created, Date lastModified, String slug, String title, String description, boolean enabled,
            List<Author> authors, Category category, LanguageCode languageCode, Difficulty difficulty) {
