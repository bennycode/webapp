...
/**
 * This Interceptor is responsible for logging genaral information about actual classname methodname and params.
 *
...
public class MethodLoggerInterceptor {
    ...
    /**
     * Logging of genaral information about actual classname methodname and params.
     *
            ...
            for (int i = 0; i < annos.length; i++) {
                ...
                if (params[i] != null) {
                    log
                            ...
                            .append(") ").
                            append(pjp.getArgs()[i]).append("\n");
                } else {
                    log
                            .append(" -       Param ")
                            .append(i + 1)
                            .append(": () ")
                            .append(pjp.getArgs()[i])
                            .append("\n");
                }
            }
        }
    ...
    private Object invokeGetter(Object invokeInObject, Field field) {
        ...
        try {
            return invokeInObject.getClass().getDeclaredMethod("get" + capitalize(field.getName()), emptyParamObjects).invoke(
                    invokeInObject, emptyParams);
        } catch (NoSuchMethodException | SecurityException | IllegalAccessException | IllegalArgumentException |
                InvocationTargetException ex) {
            try {
                return invokeInObject.getClass().getDeclaredMethod("is" + capitalize(field.getName()), emptyParamObjects).
                        invoke(invokeInObject, emptyParams);
            } catch (NoSuchMethodException | SecurityException | IllegalAccessException | IllegalArgumentException |
